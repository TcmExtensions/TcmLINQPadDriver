...
namespace MFA.Chrome.Parse.SQLite
{
    using System;
    ...
    public class SqliteFileParser : IDisposable
    {
        ...
        {
            this._stream = new FileStream(dbFilePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
            ...
            while (headerReader.Position < bodyPosition)
            {
                ...
                switch (serialType)
                {
                    ...
                    default:
                        ...
                        {
                            var length = (serialTypeValue - 12) / 2;
